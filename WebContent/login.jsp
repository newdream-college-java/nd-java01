...
<script type="text/javascript">
   function reLoadCode(){
	   ...
	   //document.forms[0].img.src="${basePath}/createCodeSvl?"+Math.random()
	    document.getElementById("img-code").src="${basePath}/createCodeSvl?"+Math.random();
   }
</script>
</head>
<body>
...
<div id="register" class="wrap">
    <div class="shadow">
        ...
        <div class="box">
            <h1>欢迎回到易买网</h1>
            <form id="loginForm" method="post" action="loginSvl" onsubmit="return checkForm(this)">
                <table>
                    <tr>
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td>
                        <input class="text" type="text" id="passWord" name="code" onfocus="FocusItem(this)" onblur="CheckItem(this);" />
                        <div style="display: inline-block;">
                        <img id="img-code" src="createCodeSvl"><a href="javascript:reLoadCode()">看不清，换一张</a>
                        </div><span></span>
