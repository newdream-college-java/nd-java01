...
<!--导航菜单-->
 <div class="bodymenu">
	...
	<div class="h20"></div>
	<form method="post" action="toPayServlet?ticketId=${ticket.tId }&uId=${user.uId}">
	<div class="main-wrap">
			...
			<div class="lineitem buyticket">
				<table width="100%">
					...
					<tr>
						...
						<td class="third"><span id="buy_startDate">${fn:substring(ticket.tStartTime,0,11)}</span>${fn:substring(ticket.tStartTime,11,16)}</td>
				...
				<div class="ticketbox">
					<div class="checkbox clearfix">
						<ul>
							<li class="cur"><span>常用联系人：</span></li> 
									<li><label class="passengerInfo"><input name="" type="checkbox" index="0" datacode="${user.tIdNumber }" datatel="${user.uPhone }" value="${user.tRealName }">${user.tRealName }</label></li>
						</ul>
					</div>
					<div class="h15"></div>
					...
					<div class="item" id="passageItem">
						...
						<ul>
							...
							<li class="second2 s_w130"><label class="left"><em>*</em>姓名：</label>
								...
								</div> <input type="text" class="txtinput w130" value="" methodname="userName" name="username" maxLength="15"></li>
							<li class="s_w180"><label class="left"><em>*</em>身份证：</label>
								...
								</div> <input type="text" class="txtinput w180" value="" methodname="cardNo" name="cardNo" maxLength="18"></li>
								<li class="s_select">
							...
							<li class="s_w130"><label class="left"><em>*</em>手机号码： </label> <input type="text" class="txtinput w130"  value="" methodname="phone" name="phone" maxLength="11"></li>
							<li class="save">
					...
					<div class="addsafe">
							...
							<div class="checkboxlink right c555">
								<label ><input type="checkbox" checked="" value="购买" id="checkboxlink" name="checkboxlink">
					...
					<div class="item item2" id="passageItemUser">
						<ul>
							...
							<div class="e_error_notice left" style="display: none;">
								...
								</div> <input type="text" value="" name="qpUserName" id="qupiaoUserName" methodname="userName" class="txtinput" style="width:150px;" maxLength="15"></li>
							<li class="s_w280"><label class="left"><em>*</em>身份证：</label>
								...
								</div> <input type="text" value="" name="qpCardNo" id="qupiaoCardNo" methodname="cardNo" class="txtinput" style="width:270px;" maxLength="18"></li>
							<li class="s_w180"><label class="left"><em>*</em>手机号码：</label> <input type="text" value="qpPhone" name="qpphone" id="qupiaoPhone" methodname="phone" class="txtinput" style="width:170px;" maxLength="11"></li>
			       ...
			       <div class="appenddiv layout">
			          ...
			          <div class="item">
			            <table>
			              <tbody>
			              <tr>
			                <td class="line">${ticket.tStartStationName }<div>${ticket.startStation.sName }</div></td>
			                <td class="line_z"><div>${ticket.tName }   ${ticket.goCarTypeName }</div><p>发车:${fn:substring(ticket.tStartTime,0,16)}</p></td>
			                <td class="line">${ticket.tEndStationName }<div>${ticket.endStation.sName }</div></td>
			              </tr>
			            </tbody></table>
			        ...
			        <div class="h20"></div> 
			        <div class="divbtn">
			          <label><input class="btn_y332" type="submit" value="确认并支付"/></label>
