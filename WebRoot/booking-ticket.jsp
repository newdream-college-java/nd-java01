...
<body class="graybg" onselectstart="return false">
	...
	<div class="main-wrap">
		...
		<div class="ticketorder">
			...
			<div class="lineitem buyticket">
				<table width="100%">
					...
					<tr>
						...
						<td><span class="allprice">¥<b class="countPrice">64.0</b></span>
						</td>
					</tr>
				</table>
			</div>
				...
				<div class="ticketbox">
					<div class="checkbox clearfix">
						<ul>
							...
							<li><label class="passengerInfo"><input name=""
									type="checkbox" index="0" datacode="43010119900605105X"
									datatel="18684858888" value="李大大">李大大</label></li>
						</ul>
					</div>
					<div class="h15"></div>
					...
					<div class="item" id="passageItem">
						...
						<ul>
							...
							<li class="second2 s_w130"><label class="left"><em>*</em>姓名：</label>
								...
								</div> <input type="text" class="txtinput w130" value=""
								methodname="userName" name="" maxLength="15"></li>
							<li class="s_w180"><label class="left"><em>*</em>身份证：</label>
								...
								</div> <input type="text" class="txtinput w180" value=""
								methodname="cardNo" name="" maxLength="18"></li>
							<li class="s_select">
							...
							<li class="s_w130"><label class="left"><em>*</em>手机号码：
							</label> <input type="text" class="txtinput w130" value=""
								methodname="phone" name="" maxLength="11"></li>
							<li class="save"><span class="save_a">将此乘客设为取票人</span></li>
					...
					<!--点击增加联系人信息-->
					<div class="addsafe">
						<a id="addBaoXianButton" class="addbtn"><em>&nbsp;</em>添加乘车人</a><span
							class="cf60 left" id="addPassageError">
							&nbsp;&nbsp;该车次单笔订单最多可购买3张车票</span>
						<div class="checkboxlink right c555">
							<label><input type="checkbox" checked="" value=""
								id="checkboxlink" name="checkboxlink"> 我要免费购买<a
								href="http://www.12308.com/bbm/pafreeins.html"
								style="color: #3b8de3;" target="_blank">《平安活动保险》</a> （最高理赔<b
								class="cf60"> 5 </b>万元） </label>
							<!-- 儿童票 -->
						</div>
					</div>

					<div class="safeprompt" style="display: none;">
						投保成功后，保险公司将生成电子保单，并将电子保单号发送到您登记的手机上，电子保单与纸质保单具有同等法律效力，您可以登录保险官网查询，下载。乘车站及12308暂不提供纸质保单。
						详情请点击 <a class="color4">保险详细说明</a>
					...
					<div class="item item2" id="passageItemUser">
						<ul>
							<li class="second2 s_w160"><label class="left"><em>*</em>姓名：</label>
								...
								</div> <input type="text" value="" id="qupiaoUserName"
								methodname="userName" class="txtinput" style="width: 150px;"
								maxLength="15"></li>
							<li class="s_w280"><label class="left"><em>*</em>身份证：</label>
								...
								</div> <input type="text" value="" id="qupiaoCardNo"
								methodname="cardNo" class="txtinput" style="width: 270px;"
								maxLength="18"></li>
							<li class="s_w180"><label class="left"><em>*</em>手机号码：</label>
								<input type="text" value="" id="qupiaoPhone" methodname="phone"
								class="txtinput" style="width: 170px;" maxLength="11"></li>
				...
				<div class="ticketbox">
					<div class="prompt">
						<ul>
							...
							<li>4、购票高峰期，由于票源紧张，支付成功不能保证100%出票。如出票失败，建议您更换其他班次或前往车站购买，12308会保证在3-7个工作日内为您退款，
								<Br />&nbsp; &nbsp;
								&nbsp;&nbsp;全额返还到原支付账户，视银行规定不同，退款将在3-21内到账。请妥善保管短信，以便实时查询订单状态。
							</li>
			...
			<div class="h50"></div>
			<div class="btns">
				<input name="" type="button" value="确认无误，提交" class="btn_y200"
					id="ticket_btn">
			</div>
			<div class="h50"></div>
			<div class="warm_prompt"
				style="width: 720px; top: 0; left: 0; background: #fff; display: none;">
				...
				<div id="buyappenddiv" style="display:;">
					<div class="appenddiv layout">
						<div class="divportent">
							<em></em> <span>支付成功后，我们会将第一时间短信通知您，请耐心等待！<br>
								...
								<table>
									<tbody>
										<tr>
											...
											<td class="line_z"><div>高档空调 X0601</div>
												<p>发车:2016-05-02 07:30</p></td>
											<td class="line">常德
												<div>常德</div>
											</td>
										</tr>
								...
								<table class="moneytable">
									<tbody>
										<tr class="moneytable_b">
											...
											<td width="22%">手机:</td>
											<td colspan="2">身份证：</td>
											<td rowspan="2" class="price"><h2>总额</h2>
												<span>￥<span id="finalPrice"></span></span></td>
										</tr>
										<tr>
											<td class="moneytable_pl">
												<p>
													全价票:<em>￥64.0×</em><span id="confirmFullPriceNum"
														class="finalPiaoNumber">1</span>
												</p>
												<p id="halfPricep">
													半价票:<em>￥0.0×</em><span id="confirmHalfPriceNum"
														class="finalPiaoNumber">0</span>
												</p> <!-- 票价:<em class="confirmPrice">￥64.0×</em><span class="finalPiaoNumber">1</span> -->
											</td>
											<td class="baoxian_pl"><span class="baoxian_ctx"
												style="color: #555;">保险:<em class="confirmPrice">￥0.0×</em><span
													id="baoXianNum" class="finalBaoXianNumber">0</span></span></td>
											<td class="servicefee_pl">服务费:<em class="confirmPrice">￥<span>0.0</span>×
											</em><span id="feeNum" class="finalPiaoNumber">1</span></td>
						...
						<div class="h20"></div>
						<div class="divbtn">
							<label id="ticket_btnSbumit"><input class="btn_y332"
								id="submitOrder" type="button" value="确认并支付"></label>
						</div>
					</div>
				</div>
			</div>
	...
	<script src="Scripts/require.js"
		data-main="http://cdn-resource-alias.12308.com/2015/js/common/buy-main-201604.js"></script>
