 ...
 <div class="partbox">
  ...
  <div class="station-con clearfix">
    ...
    <div class="station-list">
			...
			<c:forEach var="station1" items="${list1}">
				         	 <div class="item">
          	 <a title="${station1.sName}" target="_blank" href="http://chezhan.12308.com/yangshuoxian-32103.html"><div class="img"><img onerror="Picture/station.png" src="http://cdn-resource.12308.com/2015/image/station.png" alt=""/></div></a>
             <div class="intro">
               <h4><a href="http://chezhan.12308.com/yangshuoxian-32103.html">${station1.sName}</a></h4>
               <p>地址：${station1.sAddress}</p>
               <p>电话：${station1.sPhone}</p>
             </div>
             </div>
			</c:forEach>
             	</div>
         	 	   <div class="station-list_r"> 
			<c:forEach var="station2" items="${list2}">
				         	 <div class="item">
          	 <a title="${station2.sName}" target="_blank" href="http://chezhan.12308.com/yangshuoxian-32103.html"><div class="img"><img onerror="Picture/station.png" src="http://cdn-resource.12308.com/2015/image/station.png" alt=""/></div></a>
             <div class="intro">
               <h4><a href="http://chezhan.12308.com/yangshuoxian-32103.html">${station2.sName}</a></h4>
               <p>地址：${station2.sAddress}</p>
               <p>电话：${station2.sPhone}</p>
             </div>
             </div>
			</c:forEach>
             	</div>
