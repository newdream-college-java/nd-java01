...
<link href="http://cdn-resource.12308.com/2015/image/favicon.ico" type="image/x-icon"  rel="shortcut icon"/>
 <link rel="stylesheet" href="Css/yuding-min-201604.css" />
...
<div class="main-wrap">
   <div class="maintabbox">
     <div class="tabboxhead">
      <ul>
        <li class="tab1"><a class="cur"><span><s></s>汽车票预订</span></a></li>
      </ul>
     </div>
     <div class="tabboxpa">
     <!--tab1 汽车票预订-->
             ...
             <ul>
                    <li class="clearfix">
                        ...
                        <div class="s-inputbox" id="shikeStartCityClass">
                            <input type="text" name="startCityName" autocomplete="off" id="startCityName" onfocus="javascript:if(this.value=='输入中文/拼音')this.value='';" value="输入中文/拼音" class="s-input">
                            <a class="city_ico" id="city_ico" style="cursor:pointer;"></a>
                        </div>
                   
                    <li class="clearfix">
                        <label>到达城市</label>
                        <div class="s-inputbox">
                            <input type="text" validate="NotNull" autocomplete="off"  validation="endCityName" onfocus="javascript:if(this.value=='输入中文/拼音')this.value='';" postion="down" autocomplete="off" maxlength="20" name="endCityName" value="输入中文/拼音" class="s-input" id="endCityName"/>
                        </div>
                   
                   <li class="clearfix">
                        <label>出发日期</label>
                       <div id="s-inputtime" class="s-inputtime">
                          <div class="kalven-dp"><div class="dp-info"><b></b><span class="dp-text">今天</span></div>
                          <input type="text" data-prefix="" readonly maxlength="10" autocomplete="off" class="cinput textbox" name="leaveDate" value="" id="bookStartDate" data-type="oneWay"> 
                        </div>
                   <li class="pl_btn">
                        <div><input  type="button" value="立即预订" name="time" class="btn_y230" id="jueryButton"></div>
                   </li>
                </ul>
 ...
 <!--右边-->
 <div class="bodyright"><div class="map"><img src="Picture/map.png"/></div></div>
</div>
  ...
  <div class="mod-hd">
    <h2 class="coach-header"><em class="coach-type"><em>汽车票</em>热门•线路预订</em></h2>
      <ul class="tabctn" id="cities">
          ...
          <li data-tabindex="1"  ><span class="tabview-span-1">宁波</span></li>
          <li data-tabindex="2"  ><span class="tabview-span-1">太原</span></li>
          <li data-tabindex="3"  ><span class="tabview-span-1">厦门</span></li>
          <li data-tabindex="4"  ><span class="tabview-span-1">深圳</span></li>
          <li data-tabindex="5"  ><span class="tabview-span-1">淮安</span></li>
     </ul>
 </div>
 ...
 <div class="partbox">
  ...
  <div class="station-con clearfix">
    ...
    <div class="station-list">
         	 	   ...
         	 	   <div class="station-list_l"> 
         	 <div class="item">
          	 <a title="阳朔北站" target="_blank" href="http://chezhan.12308.com/yangshuoxian-32103.html"><div class="img"><img onerror="Picture/station.png" src="http://cdn-resource.12308.com/2015/image/station.png" alt=""/></div></a>
             <div class="intro">
               <h4><a href="http://chezhan.12308.com/yangshuoxian-32103.html">阳朔北站</a></h4>
               <p>地址：大村门开发区将军路280号</p>
               <p>电话：</p>
             </div>
             </div>
         	 <div class="item">
          	 <a title="平乐总站" target="_blank" href="http://chezhan.12308.com/pinglexian-32102.html"><div class="img"><img onerror="Picture/station.png" src="http://cdn-resource.12308.com/2015/image/station.png" alt=""/></div></a>
             <div class="intro">
               <h4><a href="http://chezhan.12308.com/pinglexian-32102.html">平乐总站</a></h4>
               <p>地址：新安街82号</p>
               <p>电话：0773-7882340</p>
             </div>
             </div>
             	</div>
         	 	   <div class="station-list_r"> 
         	 <div class="item">
          	 <a title="荔浦总站" target="_blank" href="http://chezhan.12308.com/lipuxian-32101.html"><div class="img"><img onerror="Picture/station.png" src="http://cdn-resource.12308.com/2015/image/station.png" alt=""/></div></a>
             <div class="intro">
               <h4><a href="http://chezhan.12308.com/lipuxian-32101.html">荔浦总站</a></h4>
               <p>地址：桂林荔浦县中园路218号</p>
               <p>电话：0773-7237099</p>
             </div>
             </div>
         	 <div class="item">
          	 <a title="南宁埌东站" target="_blank" href="http://chezhan.12308.com/nanning-3.html"><div class="img"><img onerror="Picture/station.png" src="http://cdn-resource.12308.com/2015/image/station.png" alt=""/></div></a>
             <div class="intro">
               <h4><a href="http://chezhan.12308.com/nanning-3.html">南宁埌东站</a></h4>
               <p>地址：青秀区民族大道186号(近高速入口)</p>
               <p>电话：(0771)5508333</p>
             </div>
             </div>
             	</div>
...
<div class="main_r_b">
   <div class="asktop_b"><a href="http://www.12308.com/chanel/app.html" target="_blank">
   <img src="Picture/r_t_img1.png"  alt="随时随地预订车票出行就是这么简单" width="380"/></a>
       </div>
       <div class="h20"></div>  
...
<div class="h20"></div>
<div class="askbot_b">
	<a href="http://www.12308.com/help/travellerAsk.html" target="_blank"><img src="Picture/ask_img.png" alt="有疑问？点击提问"></a>
	<p>
...
</div><script src="Scripts/require.js" data-main="http://cdn-resource-alias.12308.com/2015/js/common/yuding-main-201604.js"></script>
