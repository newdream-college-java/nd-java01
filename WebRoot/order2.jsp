...
<body>
 <div class="mianCont">
  ...
  <div class="cont">
   <div class="carImg"><img src="Picture/car2.jpg" width="961" height="27" /></div>
  ...
  <div class="zhifufangshi">
   <ul class="yinhang">
    <li><input type="radio" /><img src="Picture/yin1.gif" /></li>
    <li><input type="radio" /><img src="Picture/yin2.gif" /></li>
    <li><input type="radio" /><img src="Picture/yin3.gif" /></li>
    <li><input type="radio" /><img src="Picture/yin4.gif" /></li>
    <li><input type="radio" /><img src="Picture/yin5.gif" /></li>
    <li><input type="radio" /><img src="Picture/yin6.gif" /></li>
    <li><input type="radio" /><img src="Picture/yin7.gif" /></li>
    <li><input type="radio" /><img src="Picture/yin8.gif" /></li>
    <li><input type="radio" /><img src="Picture/yin9.gif" /></li>
    <li><input type="radio" /><img src="Picture/yin1.gif" /></li>
    <li><input type="radio" /><img src="Picture/yin2.gif" /></li>
    <li><input type="radio" /><img src="Picture/yin3.gif" /></li>
    <li><input type="radio" /><img src="Picture/yin4.gif" /></li>
  ...
  <div class="zhifufangshi">
   <ul class="yinhang">
    <li><input type="radio" /><img src="Picture/caifutong.jpg" /></li>
    <div class="clear"></div>
   </ul>
  </div><!--zhzhifufangshii/-->
  <div class="zhifufangshi">
   <ul class="yinhang">
    <li><input type="radio" /><img src="Picture/zhifubao.jpg" /></li>
    <div class="clear"></div>
   </ul>
  </div><!--zhzhifufangshii/-->
  ...
  <table class="orderList">
    ...
    <tr>
     ...
     <td>
      <dl>
       <dt><a href="proinfo.html"><img src="Picture/pro1.jpg" width="85" height="85" /></a></dt>
     ...
     <td>
     <div class="jia_jian">
      <img src="Picture/jian.jpg" width="21" height="25" class="jian" />
      <input type="text" class="shuliang" value="1" />
      <img src="Picture/jia.jpg" width="21" height="25" class="jia" />
     </div>
     </td>
     <td><strong class="red">￥70.20</strong></td>
    ...
    <tr>
     <td colspan="6"><div class="shanchu"><img src="Picture/lajio.jpg" /> 全部删除</div></td>
    </tr>
   </table><!--orderList/-->
   <table class="zongjia" align="right">
    ...
    <tr>
     <td colspan="2" style="height:50px;">
      <a href="success.html"><img src="Picture/tijao.png" width="142" height="32" /></a>
     </td>
    </tr>
   </table><!--zongjia/-->
   <div class="clears"></div>
