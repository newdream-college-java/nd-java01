...
<body>
 <div class="mianCont">
  ...
  <div class="lsg">
   <h1 class="logo"><a href="index.html"><img src="Picture/logo.png" width="217" height="90" /></a></h1>
   ...
   <div class="gouwuche">
    <div class="gouCar">
     ...
     <a href="order.html">去结算</a> <img src="Picture/youjian.jpg" width="5" height="8" />    
    </div><!--gouCar/-->
    <div class="myChunlv">
     <a href="vip.html"><img src="Picture/mychunlv.jpg" width="112" height="34" /></a>
    </div><!--myChunlv/-->
   </div><!--gouwuche/-->
  </div><!--lsg/-->
  <div class="pnt">
  ...
  <div class="cont">
   ...
   <div id="tsShopContainer">
	<div id="tsImgS"><a href="images/01.jpg" title="Images" class="MagicZoom" id="MagicZoom"><img width="300" height="300" src="Picture/01.jpg" /></a></div>
	<div id="tsPicContainer">
		<div id="tsImgSArrL" onclick="tsScrollArrLeft()"></div>
		<div id="tsImgSCon">
			<ul>
				<li onclick="showPic(0)" rel="MagicZoom" class="tsSelectImg"><img height="42" width="42" src="Picture/01.jpg" tsImgS="images/01.jpg" /></li>
				<li onclick="showPic(1)" rel="MagicZoom"><img height="42" width="42" src="Picture/02.jpg" tsImgS="images/02.jpg" /></li>
				<li onclick="showPic(2)" rel="MagicZoom"><img height="42" width="42" src="Picture/03.jpg" tsImgS="images/03.jpg" /></li>
				<li onclick="showPic(3)" rel="MagicZoom"><img height="42" width="42" src="Picture/04.jpg" tsImgS="images/04.jpg" /></li>
				<li onclick="showPic(4)" rel="MagicZoom"><img height="42" width="42" src="Picture/05.jpg" tsImgS="images/05.jpg" /></li>
				<li onclick="showPic(5)" rel="MagicZoom"><img height="42" width="42" src="Picture/06.jpg" tsImgS="images/06.jpg" /></li>
				<li onclick="showPic(6)" rel="MagicZoom"><img height="42" width="42" src="Picture/07.jpg" tsImgS="images/07.jpg" /></li>
				<li onclick="showPic(7)" rel="MagicZoom"><img height="42" width="42" src="Picture/08.jpg" tsImgS="images/08.jpg" /></li>
				<li onclick="showPic(8)" rel="MagicZoom"><img height="42" width="42" src="Picture/09.jpg" tsImgS="images/09.jpg" /></li>
				<li onclick="showPic(9)" rel="MagicZoom"><img height="42" width="42" src="Picture/10.gif" tsImgS="images/10.gif" /></li>
				<li onclick="showPic(10)" rel="MagicZoom"><img height="42" width="42" src="Picture/11.gif" tsImgS="images/10.gif" /></li>
			</ul>
		</div>
    ...
    <div class="proBoxRight">
     ...
     <div class="gc">
      <a href="order.html"><img src="Picture/goumai.png" width="117"  height="36" /></a>&nbsp;&nbsp;
      <a href="#"><img src="Picture/shoucang.png" width="117" height="36" /></a>
     </div><!--gc/-->    
    </div><!--proRight/-->
    <div class="clears"></div>
    </div><!--proBox/-->
    ...
    <img src="Picture/ban1.jpg" width="756" height="310" />
    </div><!--fangList/-->
    <div class="fangList">
     商品参数
    </div><!--fangList/-->
    ...
    <div class="fangList">
     <img src="Picture/rdpro1.jpg" width="132" height="129" /><br /><br />
     <img src="Picture/rdpro2.jpg" width="132" height="129" /><br /><br />
     <img src="Picture/rdpro3.jpg" width="132" height="129" /><br /><br />
     <img src="Picture/rdpro4.jpg" width="132" height="129" /><br /><br />
     <img src="Picture/rdpro5.jpg" width="132" height="129" /><br /><br />
    </div><!--fangList/-->
   </div><!--contRight/-->
   <div class="clears"></div>
  </div><!--cont/-->
  ...
  <div class="footer">
   ...
   <p>
    版权所有：上海17实业有限公司 版权所有  Copyright 2010-2015   沪ICP备10213975号   技术支持：<a href="http://www.sucaihuo.com/" target="_blank">秦王网络</a>
   </p>
  </div><!--footer/-->
 </div><!--mianCont/-->
