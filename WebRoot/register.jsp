...
<body class="reg_body">
	...
	<div class="header nobg">
		...
		<div class="header-container">
			...
			<div class="logo">
				...
				<a href="index.html">12308首页</a>

			</div>

			<div class="navigation color3"><a href="javascript:void(0)" target="_blank"> 客服中心</a>
			</div>
	...
	<div class="content">
        ...
        <div class="content-header"><h2>注册新会员</h2><p>已有12308帐号，<a href="login.html" target="_blank">直接登录</a></p></div>
        ...
        <form method="post" id="formPublic" action="login.html">
		...
		<div class="pub-form reg-form">
         ...
         <div class="fm-li pbot-5">
          ...
          <span class="fm-label"><label for="txt_userName">手机号码:</label></span>
             ...
             <input type="text" value="" name="phone" id="txt_Phone" class="i-input w240">

              <div class="msg-info" id="msg_Phone" >

                    <div   class="msg-weak msg-attention"><i></i>

                        <label class="valid" style="display:inline-block">友情提示：请输入您的手机号码</label>
         ...
         <div class="fm-li">
          ...
          <span class="fm-label"><label for="txt_password1">登录密码:</label></span>
             ...
             <input type="password" value="" name="txt_password1" id="txt_password1" class="i-input w240">
             ...
             <div class="qiangdu">
							...
							<span class="strong strong1" id="one">弱</span><span class="strong strong2" id="two">中</span><span class="strong strong3" id="three">强</span>
              ...
              <div  id="txt_password1Tip"   class="msg-info">
                    ...
                    <div  class="msg-weak msg-attention"><i></i>
                        ...
                        <label  class="valid" style="display:inline-block">友情提示：请输入大于6位数字和字母</label>
        ...
        <div class="fm-li pbot-5">
          ...
          <span class="fm-label"><label for="txt_password2">确认密码:</label></span>
             ...
             <input type="password" value="" name="txt_password2" id="txt_password2" class="i-input w240">

              <div id="txt_password2Tip"  class="msg-info">

                    <div    class="msg-weak msg-attention"><i></i>

                        <label    class="valid" style="display:inline-block">提示：请再次输入您的账户密码</label>
          ...
          <span class="fm-label"><label for="txt_input6">验证码</label></span>
             ...
             <input type="text" value="" name="handverifyCode" id="handverifyCode" class="i-input w80 left">

             <img style="margin-left:10px;" id="randomImg" src="Picture/3dae46a43b0844aa81419248fc608dbb.gif"/> <span style="cursor:pointer;color:#317ee7;margin-left:10px;" id="changePage"  onclick ="changeImg()" >看不清，换一组</span>
              ...
              <div class="msg-info" >
                    ...
                    <div id="handverifyCodeTip" class="msg-weak msg-attention"><i></i>

                        <label class="valid">提示：请输入内容</label>
        ...
        <!--div class="fm-li pbot-5">
         ...
         <div class="fm-li">
						...
						<p class="lo_p padbot15">
							...
							<label for="remeber_me"><input type="checkbox" checked="true" id="remeber_me" name="remeber_me" class="lo_check"><span><a href="javascript:void(0);" class="tsl c666" id="agreement-content1">我已看过并同意<b>《12308服务条款》</b></a> </span></label>

						</p>

						<div style=" display:block;" id="showContent" class="agreement-content agreement-content1">
		...
		<div class="fm-li">
          ...
          <input type="submit" value="同意协议并注册" style="background:url(Images/login.png) no-repeat 0px -240px; width:242px; height:35px;color:white;font-size:15px;"/>
            ...
            <p><b>1.为什么系统提示我的手机号已被使用？</b><br/>    

			答：出现此系统提示，表示您已经注册过，建议您直接登录。

            </p>

            <p><b>2.为什么要验证手机号？</b><br/>

			答：验证您的手机号能够更好的保障您的购票权益。



            </p>

            <p><b>3.注册手机无法获取到验证码</b><br/>

            答：无法获取的验证码，可以偿试切换成邮箱注册。
