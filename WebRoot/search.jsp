·111<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
<%
...
<link rel="shortcut icon"
	href="http://cdn-resource.12308.com/2015/image/favicon.ico"
	type="http://cdn-resource.12308.com/2015/img/x-icon" />
...
<body onselectstart="return false">
	...
	<div class="bodyhead">
		<div class="main-wrap">
			<h1 class="logo">
				<a title="12308全国汽车票网" href="http://www.12308.com">12308全国汽车票网</a>
			</h1>
			<div class="headr">
				<div class="toolkit">
...
.navmenu li.ico a, .navmenu li.ico span, .navmenu li.ico i {
		...
		<div class="bodymenu">
			<div class="mainnav">
				<ul class="navmenu">
					...
					<li class="nav_1"><a
						href="http://www.12308.com/index/chepiao.html" id="booking_menu"
					...
					<li class="nav_5"><a
						href="http://www.12308.com/baoche/index.html" title="我要包车"><i></i>我要包车<span></span></a></li>
					<li class="nav_3"><a
				...
				<ul class="navuser" id="login_content">
					...
					<li class="reg"><a title="注册" rel="nofollow"
						href="http://uc.12308.com/register/registerPage.html">注册</a></li>
					<li class="out hide" style="display: none;"><a title="退出"
						rel="nofollow">退出</a></li>
					<li class="go"><span><a title="登录"
							href="http://uc.12308.com" class="logLin">登录</a></span></li>
	...
	<div class="main-wrap">
		<div class="main_left">
				...
				<ul>
					<li><label>出发地</label>
						<div class="s-inputbox" id="shikeStartCityClass">
							<input type="text" autocomplete="off" class="s-input" value="长沙"
								id="startCityName" inputIsSubmit="1" title="输入中文/拼音" name="start-city"/> <a
								class="city_ico" id="city_ico"></a>
						</div></li>
					<li><label>目的地</label>
						<div class="s-inputbox">
							<input type="text" autocomplete="off" class="s-input" value="常德"
								id="endCityName" inputIsSubmit="1" title="输入中文/拼音" name="end-city"/>
							<!--<a class="city_ico"></a>  -->
						</div></li>
					<li><label>出发日期</label>
						<div class="s-inputtime">
							<div class="kalven-dp">
								...
								<input type="text" data-type="oneWay" id="bookStartDate"
									value="2016-05-01" name="fromDate" class="cinput textbox"
									autocomplete="off" maxlength="10" readonly data-prefix="" name="book-start-date">
								<div class="q-datepicker" style="display: none;"></div>
							</div>
						</div></li>
					<li class="li-btn"><input type="button" id="jueryButton"
			...
			<!--2016-5-1  (12308平台)  12308五一活动公告-->
			<input type="hidden" id="hideStartCityName" value="长沙" /> <input
				type="hidden" id="hideEndCityName" value="常德" /> <input
				...
				<div class="orderdiv">
						...
						<div class="timebox">
							...
							<ul>
								...
								<li><label for="上午(06:00~12:00)"> <span
										...
										class="type_txt">上午(06:00~12:00)</span> <input type="checkbox"></label></li>
								...
								<li><label for="晚上(18:00~24:00)"> <span
										...
										class="type_txt">晚上(18:00~24:00)</span><input type="checkbox"></label></li>
					...
					<div id="content" style="display: block;">
						...
						<div class="lineitem">
							<div class="head">
								<ul>
									<li class="first"><span class="icon i2"
										id="startTimeOrderBy">出发时间</span></li>
								...
								<div class="box">
									<ul>
										...
										<li class="second"><span class="start">发</span>
											<p>
												...
												<a class="color3 startStation"
													...
													target="_blank">长沙市汽车西站</a> <a class="map_icon"
													href="http://chezhan.12308.com/czSearchByName.html?stationName=长沙市汽车西站&amp;cityCode=0731"
													target="_blank"></a>
										...
										<li class="fourth  "><span class="icon i2"><span
												id="" class="price"><em>¥</em><span>64.0</span></span></span></li>
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="EB970B439C3C9E5BEC674F7C121AD335" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fourth  "><span class="icon i2"><span
												id="" class="price"><em>¥</em><span>64.0</span></span></span></li>
										<li class="fifth pt15"><span>无票</span></li>
										<li class="six pt5"><a class="btn_g80 buy-btn"
											dataid="E9135FEE790C3CCE11D1EA2AE4C8456B" datatype="0"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span>无票</span></li>
										<li class="six pt5"><a class="btn_g80 buy-btn"
											dataid="39454C6B8B64F73AF2869C301A94CFC4" datatype="0"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="95B742C042D5DD5801FFC992111CB647" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="C3A462AC6B11485E39385CCC76C9DEF3" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="29E8CBAA413025A45B7E48C31ADB456A" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="second"><span class="start">发</span>
											<p>
												...
												<a class="color3 startStation"
													href="http://chezhan.12308.com/czSearchByName.html?stationName=长沙高铁汽车站&amp;cityCode=0731"
													target="_blank">长沙高铁汽车站</a> <a class="map_icon"
													href="http://chezhan.12308.com/czSearchByName.html?stationName=长沙高铁汽车站&amp;cityCode=0731"
													target="_blank"></a>
										...
										<li class="fourth  "><span class="icon i2"><span
												id="" class="price"><em>¥</em><span>85.0</span></span></span></li>
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="7EE161BED24570C1E088811BFD28B32F" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="82623DA69D1517055E05A5E73E9FAD43" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="976DF4577C21BD0F7146415689725257" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="9B5D6F75FCC657B689E82ED2581C0B2B" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
							</div>
							<div class="content" index="2" style="display: none">
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="1ACE6D53D6B42E1B4F7483591C5C4210" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="4A33ABEAA2A00E0EC9E8256981F1168D" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="E94BFAE4124A0F7920A597CB2F0FED72" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="6FD0C1DEA66C32C6CE819B60D608A3DC" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="9F4BEB6B545B8BCC8ADC5D2A660ADF26" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="CF029D4563B4677E23FAF2E4F885C778" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="F0A7DC92EFD9DFA08E846693F7336A36" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="2B9EBF1CDE83A47DE217FA062D0FB8A8" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="D15360FF3486006F90689726705641DF" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="B2307CC22673B0856525F05D593B3BC0" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
							</div>
									...
									<ul>
										...
										<li class="second"><span class="start">发</span>
											<p>
												...
												<a class="color3 startStation"
													href="http://chezhan.12308.com/czSearchByName.html?stationName=长沙市汽车东站&amp;cityCode=0731"
													target="_blank">长沙市汽车东站</a> <a class="map_icon"
													href="http://chezhan.12308.com/czSearchByName.html?stationName=长沙市汽车东站&amp;cityCode=0731"
													target="_blank"></a>
										...
										<li class="fourth  "><span class="icon i2"><span
												id="" class="price"><em>¥</em><span>69.0</span></span></span></li>
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="913C4F43770593B019C8F095A771D0D0" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="22207C4F9D79BA962AAFB75CF17C1F50" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="64F7150C87E437DA681133AFDD944C66" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="3D2D5364FD9FB1B6D9D78A92E1736206" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="2D23058192F323723F4CF499BB01FE9D" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="3E4B1C715AD8751703B8DCC737410E54" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="9145194581B7D6273724B1CBC3AB1445" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="CD2CD5E8637CFE87D6079BA0C3B0B819" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="B2F6B706B578E3275143301A92383160" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="7947A075F4115F96D0A6641893BB126B" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
							</div>
							<div class="content" index="4" style="display: none">
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="9DBCA178FE61ACD3517E955DC60D9E2F" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="0B3357DF9725D14B90FCC04355B62332" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="D21D8BD48C92CB50E26A3B902F20CB11" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="492CD1A8142BC7D8292FA3A900E6B7A2" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="4414AD5D0992004D3983C0CF1278F2C2" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="C5117C6C3C451CD52FB83B07C64769F1" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="215351094E93927687F0898CF0137B06" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="0A9C1EDFDF93E0677C0D4B6C41356A11" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="A20485D8C7268164D74175309CA99C0D" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="DECC471763B7ABAF16EFFBE224641B32" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
							</div>
							<div class="content" index="5" style="display: none">
								<div class="box">
									<ul>
										...
										<li class="fifth pt15"><span class="green">有票</span></li>
										<li class="six pt5"><a class="btn_y80 buy-btn"
											dataid="E4DAD81657C7E801B83190A178D9ACA4" datatype="1"
											title="正常预订">预 订</a></li>
									</ul>
								</div>
							</div>
						...
						<div class="m-page-box">
							<div class="m-page">
								<a href="javascript:_obj.paging.previousPage();" class="up-page">上一页</a><a
									href="javascript:_obj.paging.changePage(1);" class="cur">1</a><a
									href="javascript:_obj.paging.changePage(2);">2</a><a
									href="javascript:_obj.paging.changePage(3);">3</a><a
									href="javascript:_obj.paging.changePage(4);">4</a><a
									href="javascript:_obj.paging.changePage(5);">5</a><a
									href="javascript:_obj.paging.nextPage();" class="down-page">下一页</a><span>共<strong>5</strong>页
									跳转到 <input type="text" id="txtGoto"
									onkeyup="if(event.keyCode==13){_obj.paging.changePage(this.value);}"
									value="1" class="txt"> 页 <input type="button"
									onclick="_obj.paging.changePage($('#txtGoto').val());"
									class="btn-bg"></span>
							</div>
						</div>
						<!--翻页-->
...
<dl id="dl_searchbox_history">
	...
	<script>
		var b = [ {
			...
			'name' : '遂溪县城，廉江',
			"simplepy" : "sxxc，lj",
			"provinceName" : "遂溪县城，廉江",
			"pinyin" : "suixixiancheng，lianjiang",
			"preDate" : "10",
			"typeNo" : 0,
			"orderby" : 0
		}, {
	...
	<script type="text/javascript"
		src="Scripts/273ea3bbbb1e4f41a98b97deae464ecd.js"></script>
	<script src="Scripts/require.js"
		data-main="http://cdn-resource-alias.12308.com/2015/js/common/search-main-201604.js?v=1"></script>
