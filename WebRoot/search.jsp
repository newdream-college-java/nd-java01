...
<link rel="shortcut icon" href="http://cdn-resource.12308.com/2015/image/favicon.ico" type="http://cdn-resource.12308.com/2015/img/x-icon" />
<meta name="keywords" content="长沙汽车票预订,长沙长途汽车票,买长沙车票" />
<meta name="description" content="12308为您提供汽车票预订{长沙到常德}，订汽车票{长沙到常德}车票12308网上订票(买全国车票)" />
 <link rel="stylesheet" href="Css/search-min-201604.css" />
 ...
 <div class="bodymenu">
	...
	<div class="main-wrap">
		<div class="main_left">
				...
				<ul>
					<li><label>出发地</label>
						<div class="s-inputbox" id="shikeStartCityClass">
							<input type="text" autocomplete="off" class="s-input" value="长沙" id="startCityName" inputIsSubmit="1" title="输入中文/拼音"/> <a class="city_ico" id="city_ico"></a>
						</div></li>
					<li><label>目的地</label>
						<div class="s-inputbox">
							<input type="text" autocomplete="off" class="s-input" value="常德" id="endCityName" inputIsSubmit="1"  title="输入中文/拼音"/> <!--<a class="city_ico"></a>  -->
						</div></li>
					<li><label>出发日期</label>
						<div class="s-inputtime">
							<div class="kalven-dp">
								<div class="dp-info">
									<b></b><span class="dp-text">明天</span>
								</div>
								<input type="text" data-type="oneWay" id="bookStartDate" value="2016-05-01" name="fromDate" class="cinput textbox" autocomplete="off" maxlength="10" readonly data-prefix="">
								<div class="q-datepicker" style="display: none;"></div>
							</div>
						</div></li>
					<li class="li-btn"><input type="button" id="jueryButton" class="btn_b110 search-btn" name="time" value="立即查询"></li>
				</ul>
			</div>
			<div class="h10"></div>
			...
			<!--2016-5-1  (12308平台)  12308五一活动公告-->
			<input type="hidden" id="hideStartCityName" value="长沙"/>
			<input type="hidden" id="hideEndCityName" value="常德"/>
			<input type="hidden" id="hideStartDate" value="2016-05-01"/>
			<input type="hidden" id="hideOrderBy" value="1"/>
			<input type="hidden" id="isSearch" value="true"/>
			<input type="hidden" id="source" value=""/>
			<!--车站列表-->
			<div class="ticketlist clearfix">
				<div class="queryhead">
					<h1>长沙→常德</h1>
					<label>车票信息<em id="scheduleCount">0</em>条
					</label>
					<div class="times" style="display:none;">
						<em class="time-ico">时间</em><a href="#" target="_blank">与汽车站同步预售，可售<b id="preDate">30</b>天
						</a>
					</div>
				</div>
					...
					<div class="searchselect layout">
						...
						<div class="timebox">
							...
							<ul>
								...
								<li><label for="上午(06:00~12:00)"> <span class="icbox" name="time" datatype="06:00~12:00"></span><span class="type_txt">上午(06:00~12:00)</span> <input type="checkbox"></label></li>
								<li><label for="下午(12:00~18:00)"> <span class="icbox" name="time" datatype="12:00~18:00"></span><span class="type_txt">下午(12:00~18:00)</span><input type="checkbox"></label></li>
								<li><label for="晚上(18:00~24:00)"> <span class="icbox" name="time" datatype="18:00~24:00"></span><span class="type_txt">晚上(18:00~24:00)</span><input type="checkbox"></label></li>
		...
		<input type="hidden" id="stationList" value="4">
	   		<li class="no_lim"><div class="on" location=""><span>不限</span></div></li>
	   		<li><label><span class="icbox" name="startplace" location="" datatype="长沙市汽车西站"></span><span class="type_txt">长沙市汽车西站</span><input type="checkbox"></label></li>
	   		<li><label><span class="icbox" name="startplace" location="" datatype="长沙高铁汽车站"></span><span class="type_txt">长沙高铁汽车站</span><input type="checkbox"></label></li>
	   		<li><label><span class="icbox" name="startplace" location="" datatype="长沙市汽车东站"></span><span class="type_txt">长沙市汽车东站</span><input type="checkbox"></label></li>
</ul>
						</div>
						<div class="clear"></div>
					</div>
					<div id="content" style="display: block;"><div class="h10"></div>
<div class="lineitem">
	<div class="head">
		<ul>
			...
			<li class="fourth"><span class="icon i2" id="ticketPriceOrderBy">票价</span></li>
	...
	<div class="content" index="1" style="display:block">
			...
			<ul>
				<li class="first">
					<p class="time">07:30</p>
						<p class="range">185KM</p>
				</li>
				<li class="second"><span class="start">发</span>
					<p>
					
						<a class="color3 startStation" href="http://chezhan.12308.com/czSearchByName.html?stationName=长沙市汽车西站&amp;cityCode=0731" target="_blank">长沙市汽车西站</a>
						<a class="map_icon" href="http://chezhan.12308.com/czSearchByName.html?stationName=长沙市汽车西站&amp;cityCode=0731" target="_blank"></a>
				...
				<li class="third">
					<p class="th_o">高档空调  </p>
							<p class="th_t">X0601</p>
					
				</li>
				<li class="fourth  ">
						<span class="icon i2"><span id="" class="price"><em>¥</em><span>64.0</span></span></span>
				</li>
				<li class="fifth pt15">
						<span class="green">有票</span>
				</li>
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="EB970B439C3C9E5BEC674F7C121AD335" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_g80 buy-btn" dataid="E9135FEE790C3CCE11D1EA2AE4C8456B" datatype="0" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_g80 buy-btn" dataid="39454C6B8B64F73AF2869C301A94CFC4" datatype="0" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="95B742C042D5DD5801FFC992111CB647" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="C3A462AC6B11485E39385CCC76C9DEF3" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="29E8CBAA413025A45B7E48C31ADB456A" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				<li class="first">
					<p class="time">10:30</p>
						<p class="range">196KM</p>
				</li>
				<li class="second"><span class="start">发</span>
					<p>
					
						<a class="color3 startStation" href="http://chezhan.12308.com/czSearchByName.html?stationName=长沙高铁汽车站&amp;cityCode=0731" target="_blank">长沙高铁汽车站</a>
						<a class="map_icon" href="http://chezhan.12308.com/czSearchByName.html?stationName=长沙高铁汽车站&amp;cityCode=0731" target="_blank"></a>
				...
				<li class="third">
					<p class="th_o">大高一            </p>
							<p class="th_t">G1019</p>
					
				</li>
				<li class="fourth  ">
						<span class="icon i2"><span id="" class="price"><em>¥</em><span>85.0</span></span></span>
				</li>
				<li class="fifth pt15">
						<span class="green">有票</span>
				</li>
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="7EE161BED24570C1E088811BFD28B32F" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="82623DA69D1517055E05A5E73E9FAD43" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="976DF4577C21BD0F7146415689725257" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="9B5D6F75FCC657B689E82ED2581C0B2B" datatype="1" title="正常预订">预 订</a>
	...
	<div class="content" index="2" style="display:none">
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="1ACE6D53D6B42E1B4F7483591C5C4210" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="4A33ABEAA2A00E0EC9E8256981F1168D" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="E94BFAE4124A0F7920A597CB2F0FED72" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="6FD0C1DEA66C32C6CE819B60D608A3DC" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="9F4BEB6B545B8BCC8ADC5D2A660ADF26" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="CF029D4563B4677E23FAF2E4F885C778" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="F0A7DC92EFD9DFA08E846693F7336A36" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="2B9EBF1CDE83A47DE217FA062D0FB8A8" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="D15360FF3486006F90689726705641DF" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="B2307CC22673B0856525F05D593B3BC0" datatype="1" title="正常预订">预 订</a>
						
				</li>
			</ul>
		</div>
	</div>
	<div class="content" index="3" style="display:none">
		<div class="box">
			<ul>
				<li class="first">
					<p class="time">14:10</p>
						<p class="range">203KM</p>
				</li>
				<li class="second"><span class="start">发</span>
					<p>
					
						<a class="color3 startStation" href="http://chezhan.12308.com/czSearchByName.html?stationName=长沙市汽车东站&amp;cityCode=0731" target="_blank">长沙市汽车东站</a>
						<a class="map_icon" href="http://chezhan.12308.com/czSearchByName.html?stationName=长沙市汽车东站&amp;cityCode=0731" target="_blank"></a>
				...
				<li class="third">
					<p class="th_o">大高一            </p>
							<p class="th_t">D0206</p>
					
				</li>
				<li class="fourth  ">
						<span class="icon i2"><span id="" class="price"><em>¥</em><span>69.0</span></span></span>
				</li>
				<li class="fifth pt15">
						<span class="green">有票</span>
				</li>
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="913C4F43770593B019C8F095A771D0D0" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="22207C4F9D79BA962AAFB75CF17C1F50" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="64F7150C87E437DA681133AFDD944C66" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="3D2D5364FD9FB1B6D9D78A92E1736206" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="2D23058192F323723F4CF499BB01FE9D" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="3E4B1C715AD8751703B8DCC737410E54" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="9145194581B7D6273724B1CBC3AB1445" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="CD2CD5E8637CFE87D6079BA0C3B0B819" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="B2F6B706B578E3275143301A92383160" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="7947A075F4115F96D0A6641893BB126B" datatype="1" title="正常预订">预 订</a>
						
				</li>
			</ul>
		</div>
	</div>
	<div class="content" index="4" style="display:none">
		<div class="box">
			<ul>
				<li class="first">
					<p class="time">16:24</p>
						<p class="range">185KM</p>
				</li>
				<li class="second"><span class="start">发</span>
					<p>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="9DBCA178FE61ACD3517E955DC60D9E2F" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="0B3357DF9725D14B90FCC04355B62332" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="D21D8BD48C92CB50E26A3B902F20CB11" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="492CD1A8142BC7D8292FA3A900E6B7A2" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="4414AD5D0992004D3983C0CF1278F2C2" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="C5117C6C3C451CD52FB83B07C64769F1" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="215351094E93927687F0898CF0137B06" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="0A9C1EDFDF93E0677C0D4B6C41356A11" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="A20485D8C7268164D74175309CA99C0D" datatype="1" title="正常预订">预 订</a>
		...
		<div class="box">
			<ul>
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="DECC471763B7ABAF16EFFBE224641B32" datatype="1" title="正常预订">预 订</a>
						
				</li>
			</ul>
		</div>
	</div>
	<div class="content" index="5" style="display:none">
		<div class="box">
			<ul>
				<li class="first">
				...
				<li class="six pt5">
							<a class="btn_y80 buy-btn" dataid="E4DAD81657C7E801B83190A178D9ACA4" datatype="1" title="正常预订">预 订</a>
...
<div class="h30"></div>
<!--翻页-->
<input type="hidden" id="dataCount" value="41">
<input type="hidden" id="pageCount" value="5">
<div class="m-page-box">
	<div class="m-page"><a href="javascript:_obj.paging.previousPage();" class="up-page">上一页</a><a href="javascript:_obj.paging.changePage(1);" class="cur">1</a><a href="javascript:_obj.paging.changePage(2);">2</a><a href="javascript:_obj.paging.changePage(3);">3</a><a href="javascript:_obj.paging.changePage(4);">4</a><a href="javascript:_obj.paging.changePage(5);">5</a><a href="javascript:_obj.paging.nextPage();" class="down-page">下一页</a><span>共<strong>5</strong>页 跳转到 <input type="text" id="txtGoto" onkeyup="if(event.keyCode==13){_obj.paging.changePage(this.value);}" value="1" class="txt"> 页 <input type="button" onclick="_obj.paging.changePage($('#txtGoto').val());" class="btn-bg"></span></div>
</div>
<!--翻页-->
<ul style="display:none;" id="station_list">
		<input type="hidden" id="stationList" value="4">
	   		...
	   		<li><label><span class="icbox" name="startplace" location="" datatype="长沙市汽车东站"></span><span class="type_txt">长沙市汽车东站</span><input type="checkbox"></label></li>
					...
					<div style="display: none;" class="promptList  promptList2" id="localSearchNoResult">
					    <div class="prompt_ic">
					...
					<div style="display: none;" class="promptList  promptList4" id="timeOutResult">
					         <div class="prompt_ic">
              					<i class="prompt_img"></i>
                  				<span class="prompt_txt">
                 					很抱歉，由于网络延迟，<br>
               				...
               				<div class="prompt_btn"><a href="javascript:{$('#isSearch').val(true);_obj.paging.search(1);}" class="btn_bs200">点击重试</a></div>
					</div>
		...
		<div class="main_right">
			<div class="main_r_b">
				...
				<div class="map_b" id="station_position" style="height:318px;width:278px;">
...
<script type="text/template" id="shortPinyinGroup-template">
		...
		<li class="let_line" data="" style="display:none"></li>
...
</script>	<script type="text/javascript" src="Scripts/273ea3bbbb1e4f41a98b97deae464ecd.js"></script>
 	<script src="Scripts/require.js" data-main="http://cdn-resource-alias.12308.com/2015/js/common/search-main-201604.js?v=1"></script> 
<!-- 	<script src="Scripts/require.js" data-main="http://cdn-resource-alias.12308.com/2015/js/chepiao_search.js?v=2"></script> -->
<div class="h40"></div>
