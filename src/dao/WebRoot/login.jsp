...
<div id="header" class="wrap">
	...
	<div class="help"><a href="#" class="shopping">购物车</a><a href="DoLogin">登录</a><a href="DoRegist">注册</a><a href="guestbook.jsp
	">留言</a></div>
	<div class="navbar">
		<ul class="clearfix">
			...
			<form id="loginForm" method="post" action="DoLogin" onsubmit="return checkForm(this)">
				<table>
					...
					<tr>
                        ...
                        <td>
                        <input class="text" type="text" id="code" name="code" onfocus="FocusItem(this)" onblur="CheckItem(this);" />
