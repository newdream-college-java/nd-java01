  ...
  <div class="main">
    ...
    <div class="content">
      ...
      <ul class="classlist">
      	...
      	//首先  创建一个News 类的集合  接收 news 集合  然后循环
      		 <%
      		 List<News> news=(List<News>)request.getAttribute("news");
      		for(News n:news ){
      		%>
      		<li><a href="#"><%=n.getNitle()%></a>
      		...
      		<p align="right"> 当前页数:[<%=request.getAttribute("curPage")%>>/1]&nbsp;&nbsp; <a href="#">首页</a><a href="index_c.jsp?curPage=<%=((Integer)request.getAttribute("curpage")-1)%>">&nbsp;&nbsp;上一页</a><a href="index_c.jsp?curPage=<%=(Integer)request.getAttribute("curpage")+1%>">&nbsp;&nbsp;下一页</a> <a href="#">&nbsp;&nbsp;末页</a></p>
...
<div id="friend">
  ...
  //   	list=(ArrayList)application.getAttribute("logined_user");
   //  out.print(list.size());
