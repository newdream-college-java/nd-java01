...
<div id="register" class="wrap">
	<div class="shadow">
		...
		<div class="box">
			...
			<form id="regForm" method="post" action="DoRegist" onsubmit="return checkForm(this);">
				<table>
					<tr>
						<td class="field">用户名(*)：</td>
						<td><input class="text" type="text" name="userName" onfocus="FocusItem(this)" onblur="doAjax(this,'servlet/CheckUserNameAction?userName='+this.value);" /><span></span></td>
					</tr>
                    <tr>
						<td class="field">真实姓名(*)：</td>
						<td><input class="text" type="text" name="realName" onfocus="FocusItem(this)" onblur="CheckItem(this);" /><span></span></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="radio" name="gender" checked="checked" value="T"/>男
						<input type="radio" name="gender" value="F"/>女<span></span></td>
					</tr>
					<tr>
						<td class="field">出生日期：</td>
						<td>
							<select name="birthyear" id="birthyear">
							 	<c:forEach var="s" begin="1990" end="2019">
							 		<c:if test="${s!=2019}">
							...
							<select name="birthmonth">
								<c:forEach var="d" begin="1" end="13">
							 		<c:if test="${d!=13}">
