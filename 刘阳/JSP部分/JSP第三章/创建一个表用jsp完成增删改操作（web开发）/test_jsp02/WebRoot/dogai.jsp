...
<html>
  ...
  <body>
    <%
    		...
    		String sid = request.getParameter("pid");//表单元素的name值
    		String sage = request.getParameter("pname");
    		...
    		int result = pdao.gai(sage,age);

    		//4.根据操作，提示用户到哪里拿结果。
    		if(result>0){
    			//告诉他到 marriedOk.jsp这个人这里拿证
    			response.sendRedirect("gaiOk.jsp");
    		}else{
    			out.print("<script>javascript:alert('失败');location.href='index.jsp'</script>");
    		}
