...
<%String path= new String(request.getParameter("tname").getBytes("ISO8859-1"), "UTF-8");
pageContext.setAttribute("tname", path);
%>
  ...
  <div id="opt_area">
    ...
    <form action="" method="post" onsubmit="return check()">
      <p>
        ...
        <input name="tname" id="tname" class="opt_input" value="${tname}" type="text"/>
