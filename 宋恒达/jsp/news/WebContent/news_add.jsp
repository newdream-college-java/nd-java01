...
<body>
	...
	<script type="text/javascript">
		function check() {
			String ntitle=document.getElementById("ntitle").value.trim();
			String nauthor=document.getElementById("nauthor").value.trim();
			String nsummary=document.getElementById("nsummary").value.trim();
			String ncontent=document.getElementById("ncontent").value.trim();
			if(ntitle==""){
				alert("标题不能为空");
				return false;	
			}
