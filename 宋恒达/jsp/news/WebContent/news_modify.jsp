...
<link href="news_modify_files/admin.css" rel="stylesheet"
	type="text/css" />
</head>
...
<body>
	<div id="header">
		...
		<div id="nav">
			<div id="logo">
				<img src="news_modify_files/logo.jpg" alt="新闻中国">
			</div>
			<div id="a_b01">
				<img src="news_modify_files/a_b01.gif" alt="">
			</div>
		</div>
	</div>
	<div id="admin_bar">
		...
		<div id="opt_area">
			...
			<form action="" method="post" onsubmit="return check()">
				<p>
					...
					</select> <input name="nid" id="nid" value="21" type="hidden" />
				</p>
				<p>
					<label> 标题 </label> <input name="ntitle" id="ntitle"
						class="opt_input" value="测试科技新闻" type="text" />
				</p>
				<p>
					<label> 作者 </label> <input name="nauthor" id="nauthor"
						class="opt_input" value="turing" type="text" />
				</p>
				<p>
					<label> 摘要 </label>
