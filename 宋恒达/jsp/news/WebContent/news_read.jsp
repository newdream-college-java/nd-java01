	...
	<div id="header">
		<div id="top_login">
			<form action="" method="post" onsubmit="return check()">
				...
				</label> <img src="news_read_files/friend_logo.gif" alt="Google"
					id="friend_logo" />
			</form>
		</div>
		<div id="nav">
					...
					<table align="center" width="80%">
						<tbody>
							...
							<tr bgcolor="aliceblue">
								<td colspan="2" align="left"><strong>摘要：新华网重庆7月20日电(记者
										张琴
										黄小希)记者从20日在重庆召开的全国新闻出版局长座谈会获悉，全国非时政类报刊出版单位将在2012年9月底前全面完成转制任务，中央和地方同步推进，分批次进行</strong></td>
							</tr>
							<tr>
