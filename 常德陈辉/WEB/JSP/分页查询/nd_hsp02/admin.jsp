		...
		<div id="main">
			...
			<div id="opt_area">
				<ul class="classlist">
					...
					<li>
						首架F-35A战机交付美国埃格林空军基地
						<span> 作者：小强 &nbsp;&nbsp;&nbsp;&nbsp; <a href="#">修改</a>
							&nbsp;&nbsp;&nbsp;&nbsp; <a href="#" onclick="return clickdel()">删除</a>
						</span>
					</li>
					...
					<li>
						默多克遭男子扔盘子袭击 妻子邓文迪反击护夫
						<span> 作者：人民网 &nbsp;&nbsp;&nbsp;&nbsp; <a href="#">修改</a>
							&nbsp;&nbsp;&nbsp;&nbsp; <a href="#" onclick="return clickdel()">删除</a>
						</span>
					</li>
