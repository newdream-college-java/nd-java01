<%@ page language="java" import="java.util.*,com.entity.*,com.dao.impl.*" pageEncoding="UTF-8"%>
<html>
	<head>
		<meta http-equiv="pragma" content="no-cache" />
		<meta http-equiv="cache-control" content="no-cache" />
		<title>新闻发布系统管理后台</title>
		<link href="topic_add_files/admin.css" rel="stylesheet"
			type="text/css" />
	</head>
	<body>
		<div id="header">
...
function check() {
	...
	return true;
		...
		<div align="left"><br></div><div id="main">
			<div id="opt_list">
				<ul>
					<li>
						<a href="#">添加新闻</a>
			...
			<div id="opt_area">
				...
				<form action="topic_add_control.jsp" method="post"
				...
				<ul style="font-size: 20px;">
							<%
								ArrayList<Topic> topics=new TopicDaoImpl().selectTopic();
								for(Topic c:topics){
							%>		
									<li>
										<%=c.getTname()%>
