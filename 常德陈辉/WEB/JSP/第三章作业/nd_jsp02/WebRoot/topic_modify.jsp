...
<html>
	<head>
		...
		<link href="topic_modify_files/admin.css" rel="stylesheet"
			type="text/css" />
	</head>
	<body>
		<div id="header">
			...
			<div id="nav">
				<div id="logo">
					<img src="topic_modify_files/logo.jpg" alt="新闻中国">
				</div>
				<div id="a_b01">
					<img src="topic_modify_files/a_b01.gif" alt="">
				</div>
			</div>
		</div>
		<div id="admin_bar">
			...
			<div id="opt_area">
				...
				<form action="" method="post" onsubmit="return check()">
					<p>
						...
						<input name="tname" id="tname" class="opt_input" value="国内"
							type="text" />
