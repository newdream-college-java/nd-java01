  ...
  <div class="main">
    ...
    <div class="content">
      ...
      <ul class="classlist">
       ...
       <p align="right"> 当前页数:[<%=(Integer)request.getAttribute("cpage")%>/<%
       int ct=(Integer)request.getAttribute("count");
       int pS=(Integer)request.getAttribute("pageSize");
       if(ct%pS==0){
    	   out.print(ct/pS);	   
       }else{
    	   out.print(ct/pS+1);	 
       ...
       <a href="index_controls.jsp?curPage=<%
       if((Integer)request.getAttribute("cpage")==1){
    	   out.print((Integer)request.getAttribute("cpage"));
       }else{
    	   out.print((Integer)request.getAttribute("cpage")-1);
       }
		%>">&nbsp;&nbsp;上一页</a>
       <a href="index_controls.jsp?curPage=<%
       ...
       %>">&nbsp;&nbsp;下一页</a>
       <a href="index_controls.jsp?curPage=<%=((Integer)request.getAttribute("count")/(Integer)request.getAttribute("pageSize"))+1%>">&nbsp;&nbsp;末页</a>
       </p>
    </div>
    <div class="picnews">
  <ul>
