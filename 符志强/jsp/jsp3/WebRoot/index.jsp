    ...
    <div class="content">
      ...
      <ul class="classlist">
			...
			conn = DriverManager.getConnection(url, "root", "123");
					String sql="select ntitle,ncreatedate from news";
					ps=conn.prepareStatement(sql);
					rs=ps.executeQuery();	
					
					while(rs.next()){
   			 %>
   			<li><a href="#"> <%=rs.getString("ntitle") %> </a>
      		<span> <%=rs.getString("ncreatedate") %></span></li>
   			 <% 
    			}
    			}catch(Exception e){
    				e.printStackTrace();
...
<div id="friend">
  ...
  <div class="friend_list">
    ...
    <%
    		//1.记录访问次数
    		//int count = 0; //局部的
    		//int cntStr = application.getAttribute("cnt");
    		application.setAttribute("cnt", ++count);
    		
			//session.getAttribute("a");
     %>
    
    	<br/>本站在线人数：<span style="font-size: 20px;color:red;font-weight:bold;"><%--=session.getAttribute("a") --%>
    	<%
