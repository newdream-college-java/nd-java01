	...
	<div id="main">
		...
		<div id="opt_area">
			<ul class="classlist">
				...
				<li>首架F-35A战机交付美国埃格林空军基地<span> 作者：小强
						&nbsp;&nbsp;&nbsp;&nbsp; <a href="#">修改</a>
				...
				<li>菲议员拟今日登南沙岛屿 中国驻菲使馆严重关切<span> 作者：小强
						&nbsp;&nbsp;&nbsp;&nbsp; <a href="#">修改</a>
						&nbsp;&nbsp;&nbsp;&nbsp; <a href="#" onclick="return clickdel()">删除</a>
				</span>
				</li>
				...
				<li>英拉议员资格获泰国选委会确认将当选女总理<span> 作者：中国新闻网
						&nbsp;&nbsp;&nbsp;&nbsp; <a href="#">修改</a>
						&nbsp;&nbsp;&nbsp;&nbsp; <a href="#" onclick="return clickdel()">删除</a>
				</span>
				</li>
				...
				<li>默多克遭男子扔盘子袭击 妻子邓文迪反击护夫<span> 作者：人民网
						&nbsp;&nbsp;&nbsp;&nbsp; <a href="#">修改</a>
						&nbsp;&nbsp;&nbsp;&nbsp; <a href="#" onclick="return clickdel()">删除</a>
				</span>
				</li>
				...
				<li>全国非时政类报刊出版单位2012年全面转制<span> 作者：新华网
						&nbsp;&nbsp;&nbsp;&nbsp; <a href="#">修改</a>
						&nbsp;&nbsp;&nbsp;&nbsp; <a href="#" onclick="return clickdel()">删除</a>
				</span>
				</li>
				...
				<li>中方强烈抗议菲律宾议员登上中国南沙岛屿<span> 作者：新华网
						&nbsp;&nbsp;&nbsp;&nbsp; <a href="#">修改</a>
						&nbsp;&nbsp;&nbsp;&nbsp; <a href="#" onclick="return clickdel()">删除</a>
				</span>
				</li>
